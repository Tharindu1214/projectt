...
<section class="section">
    <div class="sectionhead">
        <h4><?php echo Labels::getLabel('LBL_Product_Images', $adminLangId); ?>
            <?php /* echo (count($images) > 0 && is_array($product_images)) ? '(Total Images: '. count($product_images).')' : ''; */ ?><?php //echo Labels::getLabel('LBL_Product_Images',$adminLangId);?></h4>
    </div>
