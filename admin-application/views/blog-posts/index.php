                ...
                <section class="section">
                    <div class="sectionhead">
                        ...
                        <?php if ($canEdit) {
                            ...
                            $innerLiAddCat->appendElement('a', array('href'=>'javascript:void(0)','class'=>'button small green','title'=>Labels::getLabel('LBL_Add_Blog_Post', $adminLangId),"onclick"=>"addBlogPostForm(0)"), Labels::getLabel('LBL_Add_Blog_Post', $adminLangId), true);
