                ...
                <section class="section">
                    <div class="sectionhead">
                        ...
                        <?php if ($canEdit) {
                            ...
                            $innerLiAddNew->appendElement('a', array('href'=>'javascript:void(0)','class'=>'button small green','title'=>Labels::getLabel('LBL_Add_New', $adminLangId),"onclick"=>"urlForm(0)"), Labels::getLabel('LBL_Add_New', $adminLangId), true);
