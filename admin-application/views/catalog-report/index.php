				...
				<div class="page__title">
					<div class="row">
						<div class="col--first col-lg-6">
							...
							<h5><?php echo Labels::getLabel('LBL_Catalog_Report',$adminLangId); ?> <br/><strong><?php echo Labels::getLabel('LBL_Note',$adminLangId); ?>: </strong><?php echo Labels::getLabel('LBL_We_have_not_considered_impact_of_discounts_in_this_report.',$adminLangId); ?></h5>
