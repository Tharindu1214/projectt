...
$arr_flds = array(	
	...
	'totRevenue'		=>	Labels::getLabel( "LBL_Revenue", $adminLangId ),
	'totSignUpRevenue'	=>	Labels::getLabel( "LBL_Sign_Up_Revenue", $adminLangId ),
	'totOrderRevenue'	=>	Labels::getLabel( "LBL_Order_Revenue", $adminLangId ),
	'totSignUps'		=>	Labels::getLabel( "LBL_SignUps", $adminLangId ),
);
...
foreach ($arr_listing as $sn=>$row){ 
	...
	foreach ($arr_flds as $key=>$val){
		...
		switch ( $key ){
			...
			case 'totUserBalance':			
			case 'totRevenue':			
			case 'totSignUpRevenue':			
			case 'totOrderRevenue':			
...
echo FatUtility::createHiddenFormFromData ( $postedData, array (
		'name' => 'frmAffiliatesReportSearchPaging'
) );
