function loadTxt() {
    document.getElementById("tab0").innerHTML = "TEXTO";
    document.getElementById("tab1").innerHTML = "OSCURIDAD";
    document.getElementById("tab2").innerHTML = "PÁRRAFOS";
    document.getElementById("tab3").innerHTML = "LISTADOS";
    document.getElementById("tab4").innerHTML = "TAMAÑO";
