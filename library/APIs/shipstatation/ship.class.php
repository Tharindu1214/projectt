...
class Ship {
    ...
    public function __construct($apiKey='',$secretKey='') {
        ...
        require_once(CONF_INSTALLATION_PATH .'library/APIs/shipstatation/vendor/shipstation/libraries/unirest/Unirest.php');
        require_once(CONF_INSTALLATION_PATH .'library/APIs/shipstatation/vendor/shipstation/libraries/shipstation/Shipstation.class.php');
        ...
        $this->apiKey = ($apiKey)?$apiKey:'b2e47d861c25486cbb32d933d5db14d7';
        $this->apiSecret = ($secretKey)?$secretKey:'272a3451eefc4471aed056edef1e618d';
