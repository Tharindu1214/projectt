...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://khipu.com/api/2.0';
     ...
     * @var string
     */
    protected $userAgent = "khipu-api-php-client/2.6.0";
    ...
    {
        $this->userAgent = "khipu-api-php-client/2.6.0|".$name."/".$version;
    }
    ...
    public static function toDebugReport()
    {
        ...
        $report .= "    Swagger Spec Version: 2.5.0\n";
